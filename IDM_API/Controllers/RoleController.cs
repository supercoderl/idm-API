...
namespace IDM_API.Controllers
{
	...
	public class RoleController : ControllerBase
	{
		...
		public async Task<IActionResult> CreateRole(CreateRolesMapUserDTO newUserRole)
		{
		...
		public async Task<IActionResult> CreateRoleMapUser(CreateRolesMapUserDTO newUserRole)
		{
			var result = await _roleService.CreateRolesMapUser(newUserRole);
			return StatusCode(result.Status, result);
		}
		...
		[HttpPut("update-role")]
		public async Task<IActionResult> UpdateRole(int roleID, UpdateRoleDTO role)
		{
